...
for i in range(0, 1000):
  stream_data_simulator(input_s3_bucket="usaccidents-raw-useast-561826968388-proj", input_s3_key="raw-us-accidents-sample/US_Accidents_Dec20_updated_sample.csv")
